...
du kannst dein Passwort im ${companyName} System zurücksetzen.
Bitte klicke auf den Link und richte dein neues Passwort ein:
${actionLink}
`;
      const html = `
      ...
      <td style="padding:0 20px;">
        <div style="background:#ffffff; border-radius:16px; box-shadow:0 8px 24px rgba(15,23,42,0.08); overflow:hidden;">
          <div style="background:${brandPrimary}; color:#ffffff; padding:18px 24px;">
            <h1 style="margin:0; font-size:20px; font-weight:700;">Passwort zurücksetzen</h1>
            <p style="margin:6px 0 0; font-size:14px; opacity:0.9;">${companyName}</p>
          </div>
          <div style="padding:20px 24px;">
            <p style="margin:0 0 12px; font-size:14px;">Bitte klicke auf den Button und richte dein neues Passwort ein:</p>
